...
public class CustomCommand  implements Sendable<Audience> {
  ...
  /**
   * @implNote this messages command sender is going to receive on command execution, if message starts with '/' then
   * it is treated as command, and it will be executed as player, if message starts with '@/' then it will be
   * executed as console, you can use {PLAYER} placeholder to get executing player nickname
   */
  @NotNull
  private final List<String> commandResponse;
