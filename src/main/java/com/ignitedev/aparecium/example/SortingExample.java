...
public class SortingExample {
  ...
  @Example
  private  final SortingHat<ExamplePlayer> playerSort = new SortingHat<>(Set.of(new ExamplePlayer(3, true),
      new ExamplePlayer(3, false), new ExamplePlayer(3, false), new ExamplePlayer(3,
      true), new ExamplePlayer(3, false))).addFilter("gays-only", examplePlayer -> examplePlayer.gay);
  ...
  public void main(){
    ...
    @Example
    Set<ExamplePlayer> filter = playerSort.filter();
